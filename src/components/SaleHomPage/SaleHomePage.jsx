...
import useTranslateXImage from '@components/SaleHomPage/translateXImage';

function SaleHomPage() {
    const { container, content, title, desc, boxBtn, boxImage } = styles;
